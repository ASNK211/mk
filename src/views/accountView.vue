<template>
  <div style="background-color: #013363">
    ...
    <div class="cardet">
      <div class="balance">
        <p style="color: aliceblue" class="text-1xl font-semibold">balance</p>
        <div class="button-23">
      ...
      <div class="profit">
        <p style="color: aliceblue" class="text-1xl font-semibold">profit</p>
        <div class="button-23">
      ...
      <div>
        <div>
          ...
          >
            ...
            >
              <div>
                Fee 14% on withdrawals Make sure to use TRC20 network and USDT
                address
              </div>
          ...
          <div class="conste">
            ...
            >
              ...
              >
                ...
                <input type="hidden" id="testing-code" :value="usdtIdt" />
                <div class="flex items-center justify-center">
                  <button
                    role="button"
                    aria-label="no thanks"
